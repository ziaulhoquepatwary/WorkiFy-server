...
import { createJob, deleteJob, getAllJobs, getJobDetails, getMyJobs, getRecruiterJobs, updateJob } from "./job.controllers.js";
...
router.patch("/:id", verifyToken, restrictTo(ROLES.RECRUITER), updateJob);
